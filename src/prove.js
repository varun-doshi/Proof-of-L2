...
var config = {
    JsonRpcProviderUrl: {
        ...
        mainnet: "https://eth-mainnet.g.alchemy.com/v2/7dPsv4k9QI6KAuCyfQSF3tzdY7coYthq",
        sepolia: "https://eth-sepolia.public.blastapi.io",
    },
...
function loadConfigByNetwork(yaml, networksConfig, isDataSource) {
    ...
    // let targetConfig = ''
    // if (targetNetwork) {
    var targetConfig = networksConfig
...
function generateProof(blocknum, expectedState) {
    return __awaiter(this, void 0, void 0, function () {
        var wasmPath, yamlPath, wasm, wasmUint8Array, yamlContent, yaml, dsp, jsonRpcUrl, provider, generalParams, proveParams, input, userPrivateKey, zkwasmHub, signer, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    wasmPath = execOptionsForEvent.wasmPath, yamlPath = execOptionsForEvent.yamlPath;
                    wasm = fs.readFileSync(wasmPath, "utf-8");
                    ...
                    proveParams = dsp === null || dsp === void 0 ? void 0 : dsp.toProveParams(generalParams);
                    return [4 /*yield*/, cleapi.proveInputGen({ cleYaml: yaml }, // doesn't care about wasmUint8Array
                        proveParams)];
                case 1:
                    input = _a.sent();
                    // const result = await cleapi.prove(yaml, input, cleapi.BatchStyle.ZKWASMHUB);
                    console.log(input.auxParams);
                    userPrivateKey = "0x845f95446b66a3f714df0148393f61ad6dc7881223cdc2c41c9e2ef2ab7030aa";
                    zkwasmHub = "https://rpc.zkwasmhub.com:8090";
                    signer = new ethers_1.ethers.Wallet(userPrivateKey, provider);
                    return [4 /*yield*/, cleapi.requestProve({ wasmUint8Array: wasmUint8Array }, // doesn't care about cleYaml
                        input, {
                            proverUrl: zkwasmHub,
                            signer: signer,
